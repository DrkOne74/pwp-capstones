class User:
    ...
    def change_email(self, address):
        print("User address being updated from {old_email} to {new_email".format(old_email=self.email,new_email=address))
        self.email = address
...
class Book:
    ...
    def add_rating(self, rating_score):
        if rating_score >= 0 and rating_score <= 4:
            ...
            print("Invalid rating, please provide a rating from 0 to 4")
...
class TomeRater:
    ...
    def add_book_to_user(self, book, email, rating = None):
        if email in self.users.keys():
            ...
            print("User not found with email {email}!".format(email=email))
    ...
    def highest_rated_book(self):
        ...
        print("the Book with the highest rating is {name} with an average rating of {rating}".format(name=highest_avg_name, rating=highest_avg_rating))
    ...
    def most_positive_user(self):
        ...
        print("The user with the most positive rating is {name} with average rating of {rating}".format(name=highest_name, rating=highest_avg_rating))
